...
<header>
  ...
  <div class="header-center">
      ...
      <a href="pendingchequescontroller" class="back-button">Pending Cheques</a>
      <a href="issuedchequescontroller" class="back-button">Issued Cheques</a>
  </div>
...
<div class="form-box">
    <h1>Money Transfer By Cheque</h1>
    <hr>
    <form action="validatingcheque" method="post">
        <div id="fromAccountField">
            <label for="fromAccount">From Account Number:</label>
            <select name="chequeFromAccountNumber" required>
        ...
        <div id="toAccountField">
            ...
            <input type="number" id="toAccount" name="chequeToAccountNumber" required>
        </div>
      
        <div id="amountField">
            <label for="amount">Amount:</label>
            <input type="number" id="amount" name="chequeAmount" required>
        </div>
      
        <!-- <div id="chequeNumberField">
            <label for="chequeNumber">Cheque Number:</label>
            <input type="number" id="chequeNumber" value="${chequenumber}" name="chequeNumber" required>
        </div> -->
