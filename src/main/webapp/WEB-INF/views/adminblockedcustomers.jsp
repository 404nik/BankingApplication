...
<!-- Page Content -->
<h1 class="pending-title">Blocked Customers</h1>
<hr>
...
<div class="table-container">
    <table>
        ...
        <c:forEach items="${blockedCustomers}" var="customer">
            <tr>
                ...
                <td class="action-links">
                    <a href="/app/unblockCustomer/${customer.customerId}" class="approve-button">Unblock</a>
