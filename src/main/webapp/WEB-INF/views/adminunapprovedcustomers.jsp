...
<div class="table-container">
    <table>
        ...
        <c:forEach items="${unapprovedCustomers}" var="customer">
            <tr>
                ...
                <td class="action-links">
                    <a href="/app/approveCustomer/${customer.customerId}" class="approve-button">Accept</a>
                    <a href="/app/rejectCustomer/${customer.customerId}" class="reject-button">Reject</a>
                </td>
            </tr>
        </c:forEach>
    </table>
