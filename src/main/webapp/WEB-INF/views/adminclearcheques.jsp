...
<!-- Page Content -->
<h1 class="pending-title">New Cheques</h1>
<hr>
...
<div class="table-container">
    <table>
        ...
        <c:forEach items="${issuedadmincheques}" var="cheque">
            <tr>
                ...
                <td class="action-links">
                    <a href="/app/issueCheque/${cheque.chequeNumber}" class="approve-button">Approve</a>
