...
<link rel="icon" type="image/x-icon" href="https://t4.ftcdn.net/jpg/00/61/06/27/360_F_61062796_NF87GPnWV0fQ2LhoYNlyjev0PocRwZj9.jpg"> <!-- Update this if you have a specific logo -->
<style>
    body {
...
<div class="form-container">
    <div class="form-box">
        ...
        <hr>
        <f:form action="customervalidation" method="post" modelAttribute="customerlogin">
            <table>
                <tr>
                    <td>Username</td>
                    <td><f:input path="customerId" /></td>
                    <td><f:errors path="customerId" cssClass="errors" /></td>
                </tr>
                <tr>
                    <td>Password</td>
                    <td><f:input type="password" path="customerPassword" id="password" /></td>
                    <td><f:errors path="customerPassword" cssClass="errors" /></td>
                </tr>
                <tr>
            ...
            <a href="precustomeradd" class="create-account"> Dont Have An Account ? Register Now</a>
        </f:form>
    </div>
</div>
