...
<header>
    ...
    <div class="header-center">
        <a href="/app/customerchequecontroller" class="back-button">Back</a>
    </div>
...
<!-- Page Content -->
<h1 class="pending-title">Pending Requests</h1>
<hr>
...
<div class="table-container">
    <table>
        ...
        <c:forEach items="${pendingcheques}" var="cheque">
            <tr>
                <td>${cheque.chequeNumber}</td>
                <td>${cheque.toAccountNumber}</td>
                <td>${cheque.fromAccountNumber}</td>
                <td>${cheque.amount}</td>
                <td>${cheque.chequeIssueDate}</td>
                <td>${cheque.chequeClearanceDate}</td>
                <td>${cheque.chequeStatus}</td>
                <td class="action-links">
                    <a href="/app/approveCheque/${cheque.chequeNumber}" class="approve-button">Approve</a>
                    <a href="/app/rejectCheque/${cheque.chequeNumber}" class="reject-button">Reject</a>
                </td>
            </tr>
        </c:forEach>
    </table>
