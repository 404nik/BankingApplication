...
<!-- Page Content -->
<h1 class="pending-title">New Account Requests</h1>
<hr>
...
<div class="table-container">
    <table>
        ...
        <c:forEach items="${newAccounts}" var="account">
            <tr>
                ...
                <td class="action-links">
                    <a href="/app/approveAccount/${account.accountNumber}" class="approve-button">Approve</a>
                    <a href="/app/rejectAccount/${account.accountNumber}" class="reject-button">Reject</a>
                </td>
            </tr>
        </c:forEach>
    </table>
